...
export const DIALOGUE = {
  ...
  glowmoth_sefa:    { root: node('Glowmoth-Keeper Sefa', "Hush now, hold your hands flat — the moths spook at grabbing. Light's a guest, not a catch.", [end('Farewell.')]) },
  ...
  auralis:          { root: node('Skywarden Auralis', "Hold still. The green is leaning west — that means a storm by the third watch. Do not thank me; thank me by surviving it.", [end('Farewell.')]) },
  thresk:           { root: node('Ice-warden Thresk', "Path's open to the Throne. It won't be by nightfall, so move. Skywarden reads the sky; I read the ice.", [end('Farewell.')]) },
  vetr:             { root: node('Vetr the Frostbound', "The curtains came down and touched the spire last night. They were… asking after you, I think. Sit. Listen.", [end('Farewell.')]) },
  ...
  greywarden:       { root: node('Greywarden Oslo', "Mind the rope-line. Past it, the world simply stops. Walk slow here — slow keeps you on the living side.", [end('Farewell.')]) },
  wispbinder:       { root: node('Marrow the Wisp-binder', "Hold still — there's a wisp on your shoulder. Lucky; they like the newly-arrived. Every wisp's a held breath, and some are words.", [end('Farewell.')]) },
  relictrader:      { root: node('Tace Greypalm', "Petrified heartwood, shade-iron, a wisp in glass — all fairly priced, no haggling at the edge. Buy a lantern before you wander.", [end('Farewell.')]) },
  salma_brinewright: { root: node('Salma Tidewright', "Rake at dusk, child — drag salt in the noon glare and you'll harvest nothing but ache. The pan tells you when it's ready.", [end('Farewell.')]) },
