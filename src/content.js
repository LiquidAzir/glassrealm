...
export const NPC_CHATS = [
  ...
  { a: "smith", b: "fisher", lines: [{ who: "smith", text: "Three trout, properly cooked, beats bread when you're tired." }, { who: "fisher", text: "And a blade that won't break midswing beats a full belly." }, { who: "smith", text: "Bring me the catch, I'll bring you steel." }, { who: "fisher", text: "Tight lines and a sharp blade — the isle's honest fortune." }] },
